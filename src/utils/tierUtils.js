...
// Pull-ups / Dips — added kg above bodyweight (e1RM basis, unweighted = 0)
// T1=0kg (can do pull-ups), T2=+5kg, T3=+15kg, T4=+25kg, T5=+37.5kg, T6=+52.5kg, T7=+70kg
export const PULLUP_THRESHOLDS = [0, 5, 15, 25, 37.5, 52.5, 70]
